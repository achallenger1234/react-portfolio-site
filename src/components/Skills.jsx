...
export const Skills = () => {
    ...
    useEffect(() => {
        ...
        axios.get('https://api.github.com/users/achallenger1234/repos').then((response)=>{
    ...
    const converseCoutToPercentage =(count) => {
                        ...
                        state.requestState === requestStates.success && (
                            sortedLanguageList().map((item,index) => (
                                <div className="skill-item" key={index}>
                                    ...
                                    <Circle 
                                        animate
                                        progress={converseCoutToPercentage(item.count)}
                                    />
                                </div>
                            ))
                        )
